...
class Testing(unittest.TestCase):
    def setUp(self):
        ...
        oasis_song = open("../full_songs/Dont Look Back In Anger.wav", 'rb')
        file = base64.b64encode(oasis_song.read()).decode('utf-8')
        oasis_song.close()
    ...
    def test3(self):
        oasis_song = open("../full_songs/Dont Look Back In Anger.wav", 'rb')
        full_file = base64.b64encode(oasis_song.read()).decode('utf-8')
        oasis_song.close()
        hdrs = {"Content-Type" : "application/json"}
